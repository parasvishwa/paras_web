  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0, padding: 12 }}>
        ...
        {c.reporter?.fullname && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 5, marginBottom: 10 }}>
            {c.reporter.profilePhoto ? (
              <Image src={c.reporter.profilePhoto} alt="" width={18} height={18} style={{ borderRadius: '50%', objectFit: 'cover', flexShrink: 0 }} />
            ) : (
        ...
        {/* View Details label (card itself is the link) */}
        <span
          style={{
            display: 'inline-block',
...
export default function RescuePageClient() {
