          ...
          <Section title="Basic Information" icon={<Building2 size={16} />}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
              <button onClick={() => photoRef.current?.click()}
                style={{ width: 72, height: 72, borderRadius: '50%', border: '2px dashed var(--border)', background: profilePreview ? 'none' : 'var(--canvas)', cursor: 'pointer', overflow: 'hidden', position: 'relative', flexShrink: 0 }}>
                {profilePreview
